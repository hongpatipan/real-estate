            ...
            <div class="container-fluid">
                ...
                <!--<div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        $id = $_GET['id'];
                        $query = "SELECT * FROM pnews_db WHERE id='$id' ";
                        ...
                        ?>
                                    <form action="adcode.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="add_name" value="<?php echo $row['pn_name']; ?>" required class="form-control" placeholder="name">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="col-sm-3 control-label"></label>
                                            <input type="file" name="text_image" class="form-control">
                                            <input type="hidden" name="text_image_old" value="<?php echo $row['pn_image']; ?>">
                                        </div>
                                        <img src="<?php echo "upload2/" . $row['pn_image']; ?>" width="100px">
                                        ...
                                        <div class="col-md-1 mb-3 text-center">
                                            <div class="btnsub">
                                                <button type="submit" name="update_news_image" class="btn text-white">UPDATE</button>
                                            </div>
                                        </div>
                                    </form>
                                <?php
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        ?>
                                <form action="adcode.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <input type="text" name="edit_name" value="<?php echo $row['pn_name']; ?>" class="form-control" placeholder="name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <input type="file" name="faculty_image" id="faculty_image" value="<?php echo $row['pn_image']; ?>" class="form-control">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <textarea name="edit_description" required id="input-ckeditor" class="form-control"></textarea>
                                    </div>

                                    <div class="col-md-1 mb-3 text-center">
                                        <div class="btnsub">
                                            <button type="submit" name="update_btn" class="btn text-white">UPDATE</button>
                                        </div>
                                    </div>
                                </form>
